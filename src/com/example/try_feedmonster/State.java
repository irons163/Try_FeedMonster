...
class HappyState extends State{ //表示高興狀態的類別
	...
	public void alone() {
		// TODO Auto-generated method stub
		gameDog.setBitmapAndAutoChangeWH(BitmapUtil.common);//換圖
		gameDog.scene.myTextView.setText("狀態：普通");	
...
class CommonState extends State{ //表示普通狀態的類別
	...
	public void bath() {
		// TODO Auto-generated method stub
		gameDog.setBitmapAndAutoChangeWH(BitmapUtil.happy);//換圖
		gameDog.scene.myTextView.setText("狀態：普通");	
	...
	public void alone() {
		// TODO Auto-generated method stub
		gameDog.setBitmapAndAutoChangeWH(BitmapUtil.away);//換圖
		gameDog.scene.myTextView.setText("狀態：出走");	  
